...
# =================== 13. 請求もれ・入金もれチェック表 ===================
def seikyu():
    p1 = '''<h1>請求もれ・入金もれチェック表<small>「請求したか」と「入金されたか」は別の話です。月に1回、5分で確認します</small></h1>

  <div class="band">仕事は終わった。請求書も出した。<b>そこで安心してしまいます。</b><br>
    入金されていないことに、<b>何ヶ月も気づかない人がいます。</b><br>
    金額が合わないまま入金されて、そのままになっていることもあります。</div>

  <div class="box accentbox">
    <h3>いつ開くか、先に決めてください</h3>
    <div style="margin-top:1.5mm;font-size:11pt;">
      毎月 <span class="fld" style="width:14mm;"></span> 日　←　ここに日付を書いてください</div>
    <div style="margin-top:2mm;">おすすめは<b>月末か、月初の5日以内</b>です。
    多くの取引先が「月末締め・翌月末払い」なので、そのリズムに合います。<br>
    <b>やることは、表の「入金」の欄を上から見るだけ。5分で終わります。</b></div>
  </div>

  <div class="box">
    <h3>2024年11月から、支払いには期限があります</h3>
    <b>フリーランス法（2024年11月1日施行）</b>により、発注者は
    <b>納品を受けた日から60日以内の、できる限り短い期間</b>で支払期日を定め、その日までに払う義務があります。<br>
    <b>期日を決めなかった場合は「納品日」が支払期日</b>とみなされます。
    60日を超える期日を決めた場合は、<b>60日目</b>が支払期日とみなされます。<br>
    つまり<b>「うちは支払いが3ヶ月後です」は、通りません。</b>
  </div>

  <div class="box">
    <h3>取引条件は、書面かメールでもらう権利があります</h3>
    同じ法律で、発注者には<b>業務内容・報酬額・支払期日などを書面等で明示する義務</b>があります。<br>
    <b>口頭だけの発注は、あなたが不利になります。</b>
    受けた直後に<b>「内容の確認でメールをいただけますか」</b>と送ってください。それだけで記録が残ります。
  </div>

  <div class="box">
    <h3>請求額と入金額が違うとき、たいていは源泉徴収です</h3>
    報酬から<b>10.21%</b>が引かれて振り込まれることがあります（1回100万円を超える部分は20.42%）。
    <b>これは取られたのではなく、先に納めた所得税です。</b>確定申告で戻ることがあります。<br>
    表の「入金額」の欄に実際の額を書いておくと、申告のときに合計が出せます。
  </div>

  <div class="box">
    <h3>後回しにされない請求書は、この6つが入っています</h3>
    <b>1.</b> 請求日　<b>2.</b> 宛名（会社名・部署・担当者名）　<b>3.</b> 品名と数量<br>
    <b>4.</b> 金額（税率ごとに分ける）　<b>5.</b> 振込先　<b>6.</b> <b>お支払期限の日付</b><br>
    <b>6が抜けている請求書は、締め日の判断を相手に預けたことになります。</b>
    インボイスに登録しているなら、登録番号も入れてください。
  </div>

  <div class="box" style="margin-top:auto;">
    <h3>売掛金の時効は5年です</h3>
    払われていない報酬を請求できる権利は、<b>5年で消えます。</b>
    去年の分を思い出したなら、まだ間に合います。
  </div>'''

    body = rows(21, 7, "8.4mm")
    p2 = f'''<div class="head">
    <div><h1 style="font-size:21pt;">案件と入金の一覧<small>1案件1行。納品したら、その日に1行足してください</small></h1></div>
    <div class="fields"><span class="fld" style="width:14mm;"></span> 年
      <span class="fld" style="width:10mm;"></span> 月ぶん</div>
  </div>

  <table style="margin-top:4mm;">
    <tr class="hl"><th>相手先・案件</th><th style="width:18mm;">納品日</th>
      <th style="width:18mm;">請求日</th><th style="width:24mm;">請求額</th>
      <th style="width:22mm;">入金予定日</th><th style="width:24mm;">入金額</th>
      <th style="width:13mm;">入金</th></tr>
    {body}
    <tr class="sum"><td style="text-align:center;">合計</td><td></td><td></td><td></td>
      <td></td><td></td><td></td></tr>
  </table>

  <div class="box accentbox" style="margin-top:3mm;padding:2.5mm 4.5mm;line-height:1.6;">
    <h3 style="font-size:10.5pt;">「請求日」が空のまま月をまたいだ行が、いちばん危ない</h3>
    入金がないのではなく、<b>そもそも請求書を出していない</b>ことがあります。
    相手は届いていない請求書を払えません。<b>ここが空欄の行を、先に片づけてください。</b>
  </div>

  <div class="box" style="margin-top:2.5mm;padding:2.5mm 4.5mm;line-height:1.6;">
    <h3 style="font-size:10.5pt;">入金額の欄は、必ず実際の数字を書いてください</h3>
    請求額をそのまま写さないでください。<b>差額に気づけなくなります。</b>
    源泉徴収なら差額は請求額の10.21%です。<b>それ以外の差額は、相手に確認する理由になります。</b>
  </div>'''

    p3 = '''<h1 style="font-size:21pt;">入金がないときの3段階<small>感情を入れずに、順番どおり送るだけです</small></h1>

  <div class="box">
    <h3>1段目：予定日の翌営業日〜3日後</h3>
    <div style="margin-top:1.5mm;border-left:2.6pt solid var(--accent);padding-left:4mm;line-height:1.8;">
      「◯月分のご請求について、行き違いでしたら失礼いたします。<br>
      本日時点で入金の確認が取れておりませんので、<b>ご確認いただけますでしょうか。</b>」</div>
    <div style="margin-top:2mm;"><b>ここで9割は終わります。</b>担当者が処理を忘れているだけのことが、いちばん多いからです。
    「行き違いでしたら失礼いたします」を入れておけば、角は立ちません。</div>
  </div>

  <div class="box">
    <h3>2段目：1段目から1〜2週間、返事がないとき</h3>
    <div style="margin-top:1.5mm;border-left:2.6pt solid var(--accent);padding-left:4mm;line-height:1.8;">
      「◯月◯日にご連絡した件、その後いかがでしょうか。<br>
      請求書の日付は◯月◯日、<b>お支払期日は◯月◯日</b>でお願いしております。<br>
      <b>お支払いの見込み日</b>だけ、ご返信いただけますと助かります。」</div>
    <div style="margin-top:2mm;"><b>日付を3つ入れるのが要点</b>です。記録として残り、相手の社内でも動かしやすくなります。
    責める言葉は書かないでください。<b>必要なのは入金であって、謝罪ではありません。</b></div>
  </div>

  <div class="box accentbox">
    <h3>3段目：それでも動かないとき</h3>
    <b>フリーランス・トラブル110番</b>（厚生労働省の委託事業）に相談してください。
    <b>弁護士に無料で相談でき、和解のあっせんまで無料</b>です。<br>
    支払遅延はフリーランス法の違反にあたる場合があり、
    <b>公正取引委員会・中小企業庁・厚生労働省への申出</b>もできます。申出を理由に不利益な扱いをすることは禁止されています。<br>
    <b>「相談しました」と言えること自体が、次の交渉を変えます。</b>
  </div>

  <div class="box">
    <h3>次から同じことを起こさないための2行</h3>
    <b>1.</b> 受注のときに<b>支払期日をメールで確認する。</b>「納品後60日以内」が法律の上限です<br>
    <b>2.</b> 請求書に<b>「お支払期限：◯月◯日」</b>と必ず書く。書いていない請求書は、後回しにされます
  </div>

  <div class="box">
    <h3>入金以外でも、禁止されていることがあります</h3>
    <b>1ヶ月以上の継続した業務委託</b>では、発注者に次の行為が禁止されています。<br>
    <span style="display:inline-block;margin-top:1mm;line-height:1.8;">
    ・受け取りを拒む　・<b>あとから報酬を減らす</b>　・返品する　・<b>相場より著しく低い額を押しつける</b><br>
    ・商品やサービスの購入を強制する　・タダで何かをさせる　・<b>理由なく内容を変える／やり直させる</b></span><br>
    <b>「今回だけ安くして」「これも一緒にお願い」が続くなら、これに当たる可能性があります。</b>
    2ページ目に金額を残しておくと、そのときの証拠になります。
  </div>

  <div class="box" style="margin-top:auto;">
    <h3>書く回数</h3>
    <b>納品した日に1行。月に1回、入金の欄を見るだけ。</b>それ以外の日は開きません。
  </div>'''

    return [page(p1, "請求もれ・入金もれチェック表", "1 / 3　使い方と、支払いのルール"),
            page(p2, "請求もれ・入金もれチェック表", "2 / 3　案件と入金の一覧"),
            page(p3, "請求もれ・入金もれチェック表", "3 / 3　入金がないとき")]


PRODUCTS.update({"seikyu": ("請求もれ・入金もれチェック表", seikyu)})
